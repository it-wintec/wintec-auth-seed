...
<!-- Modal -->
<div class="modal fade" id="JackModal" tabindex="-1" role="dialog" aria-labelledby="wintecModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="wintecModalLabel">Online Reservations</h5>
...
<script type="text/javascript">
    ...
    var btnLadda, disableJson, sid = 1;
    $(function () {
